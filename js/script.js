...
window.addEventListener('DOMContentLoaded', () => {
    ...
    function setClock(selector, endtime) {
        const timer = document.querySelector(selector),
              ...
              timeInterval = setInterval(updateClock, 5000);
    ...
    const message  = {
        ...
        success: 'Rahmat! Biz siz bn tez orada boglanamiz',
        failure: 'Omadsizlik'
    };
    ...
    function showThanksModal(message) {
        ...
        prevModalDiaolg.style.display = 'none';
        openModal();
        ...
        setTimeout(() => {
            thanksModal.remove();
            prevModalDiaolg.style.display = 'block';            
            closeModal();
        }, 4000);
    }
